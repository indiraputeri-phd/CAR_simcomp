...
\includegraphics[width=0.7\textwidth,height=\textheight]{figures/maprec.png}
...
\phantomsection\label{cell-fig-biasarealevel}
\begin{figure}[H]

\centering{

\includegraphics[width=0.75\textwidth,height=\textheight]{figures/bias1b_plot.pdf}
...
\phantomsection\label{cell-fig-biaspointlevel}
\begin{figure}[H]

\centering{

\includegraphics[width=0.75\textwidth,height=\textheight]{figures/bias2_plot.pdf}
...
\section{Model Comparison for area-level data}\label{secA3}

\begin{table}

\caption{\label{tbl-modelcomp2}This table compares the performance of
